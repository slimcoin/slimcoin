...
BOOST_AUTO_TEST_CASE(dcryptHash)
{
  const char muchWow[] = "To the MOON!";
  uint256 manyHash = dcrypt((const u8int*) muchWow, strlen(muchWow));

  BOOST_CHECK(manyHash == uint256("29fdf732157448869660081119021fbc6ceaf91b1676c5168ba4286d46bc3ab2"));

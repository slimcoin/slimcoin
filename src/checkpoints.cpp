...
namespace Checkpoints
{
  ...
  static MapCheckpoints mapCheckpoints =
    ...
    ( 9012,   uint("0x00000006b2c364c71c279977abc8adf528d25263fb3b4fa623a309745d9f6246"))
    ( 9013,   uint("0x000000064ce948cdba2c2223dd75c3677847a00daded6be78a097db82d616eee"))
    ;
  ...
  // slimcoin: synchronized checkpoint (centrally broadcasted)
  ...
  // slimcoin: get last synchronized checkpoint
  ...
  // slimcoin: only descendant of current sync-checkpoint is allowed
  ...
  // slimcoin: reset synchronized checkpoint to last hardened checkpoint
...
// slimcoin: sync-checkpoint master key
...
// slimcoin: verify signature of sync-checkpoint message
...
// slimcoin: process synchronized checkpoint

...
static const uint256 hashGenesisBlockOfficial("0x0000032ffebaa8a80407436d163f78662a7286b95b4acaaba67b72b8aa5cd0ac");
static const uint256 hashGenesisBlockTestNet("0x00009afc8b8fad29bd605771360c9c185b4ea409774e1439cdb904b894897489");
...
public:
  ...
  {
    // slimcoin: the coin stake transaction is marked with the first output empty
  ...
  */
  ...
  bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // slimcoin: get transaction coin age
...
public:
  ...
  unsigned int nFile;
  unsigned int nBlockPos;
  CBigNum bnChainTrust; // slimcoin: trust score of block chain
  int nHeight;
  int64 nMint;
  int64 nMoneySupply;
